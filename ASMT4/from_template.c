...
// "File mem_tracer.c, line X, function F reallocated the memory segment at addressA to a new size S"
// Information about the function F should be printed by printing the stack (use PRINT_TRACE)

void* REALLOC(void* p,int t,char* file,int line) {
        printf("=====\n");
        printf("File=%s, line=%d, function_trace=%s\n", file, line, PRINT_TRACE());
        printf("reallocated the memory segment at address %p to a new size of %d\n", p, t);
        printf("=====\n");
